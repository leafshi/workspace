...
class SalesOrder224Controller {
    ...
    def create = {
        def salesOrderInstance = salesOrder224Service.init(params)
        render view : '/b2b/salesOrder224/create', model : [salesOrderInstance: salesOrderInstance]
    }

    def save = {
        def salesOrderInstance = new SalesOrder(params)
        if (salesOrder224Service.insert(salesOrderInstance)) {
    ...
    def show = {
        ...
        if (!salesOrderInstance) {
            ...
            render view : '/b2b/salesOrder224/show', model : [salesOrderInstance: salesOrderInstance]
        }
    }
    ...
    def edit = {
        ...
        if (!salesOrderInstance) {
            ...
            render view : '/b2b/salesOrder224/edit', model : [salesOrderInstance: salesOrderInstance]
        }
    }
    ...
    def update = {
        ...
        if (salesOrderInstance) {
            ...
            if (salesOrder224Service.update(salesOrderInstance, params)) {
