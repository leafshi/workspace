...
class SalesOrder222Controller {

	def salesOrder222Service
    ...
    def create = {
		def salesOrderInstance = salesOrder222Service.init(params)
        render view : '/b2b/salesOrder222/create', model : [salesOrderInstance: salesOrderInstance]
    }

    def save = {
        def salesOrderInstance = new SalesOrder(params)
        if (salesOrder222Service.insert(salesOrderInstance)) {
    ...
    def show = {
        ...
        if (!salesOrderInstance) {
            ...
            render view : '/b2b/salesOrder222/show', model : [salesOrderInstance: salesOrderInstance]
        }
    }
    ...
    def edit = {
        ...
        if (!salesOrderInstance) {
            ...
            render view : '/b2b/salesOrder222/edit', model : [salesOrderInstance: salesOrderInstance]
        }
    }
    ...
    def update = {
        ...
        if (salesOrderInstance) {
            ...
            if (salesOrder222Service.update(salesOrderInstance, params)) {
