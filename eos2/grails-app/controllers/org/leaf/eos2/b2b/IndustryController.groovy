...
class IndustryController {
    ...
    def create = {
        ...
        render view : '/b2b/industry/create', model : [industryInstance: industryInstance]
    }
    ...
    def show = {
        ...
        if (!industryInstance) {
            ...
            render view :'/b2b/industry/show', model: [industryInstance: industryInstance]
        }
    }
    ...
    def edit = {
        ...
        if (!industryInstance) {
            ...
            render view :'/b2b/industry/edit', model: [industryInstance: industryInstance]
        }
    }
