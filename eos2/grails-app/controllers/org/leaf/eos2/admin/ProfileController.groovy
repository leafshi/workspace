...
class ProfileController {
    ...
    def create() {
        render view : '/admin/profile/create', model : [profileInstance: new Profile(params)]
    }

    def save() {
        def profileInstance = new Profile(params)
        if (!profileInstance.save(flush: true)) {
            render(view: "/admin/profile/create", model: [profileInstance: profileInstance])
            return
        }
    ...
    def show(Long id) {
        ...
        render view :'/admin/profile/show', model: [profileInstance: profileInstance]
    }
    ...
    def edit(Long id) {
        ...
        render view : '/admin/profile/edit', model : [profileInstance: profileInstance]
    }
