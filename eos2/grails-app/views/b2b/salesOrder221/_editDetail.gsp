    ...
    <td name="product">
    	<ul>
			...
			<li>
				...
				${include(controller : 'salesOrder221Ajax', action : 'productCategoryOfCG', params : [productId : salesOrderDetailInstance?.product?.id] )}
			</li>
			<li>
...
<tr class="${(i % 2) == 0 ? 'odd' : 'even'} hide_detail" parent="${salesOrderDetailInstance?.serialNumber}" coordinate="${i},${j}">
    ...
    <td name="product">
    	<ul>
			...
			<li>
				<g:message code="category.warehouse.label"/> : 
				${include(controller : 'salesOrder221Ajax', action : 'productCategoryOfCG', params : [productId : salesOrderDetailDetailInstance?.product?.id] )}
			</li>
		</ul>
