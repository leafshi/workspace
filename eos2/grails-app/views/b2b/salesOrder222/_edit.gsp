	...
	<table id="salesOrder_detail_list">
    	...
    	<thead>
        	<tr>
                ...
                <th><label><g:message default="Quantity" code="salesOrderDetail.quantity.label" /></label></th>
				<th><label><g:message default="Delivery Limitation" code="salesOrderDetail.deliveryLimitation.label" /></label></th>
        ...
        <tbody>
			<g:each in="${salesOrderInstance.salesOrderDetails}" status="i" var="salesOrderDetailInstance">
				<g:render template="/b2b/salesOrder222/editDetail" model="['salesOrderDetailInstance':salesOrderDetailInstance,'i':i]"/>
			</g:each>
		</tbody>
		<tfoot>
			<td>&nbsp;</td>
...
<g:render template="/b2b/salesOrder222/javascript" />
