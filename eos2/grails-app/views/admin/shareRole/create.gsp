...
<html>
	...
	<body>
		<a href="#create-shareRole" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>

		<div id="create-shareRole" class="content scaffold-create" role="main">
